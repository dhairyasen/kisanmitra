...
SEVERITY_LABELS_LANG = {
    ...
    "gu": {1:"ઓછું", 2:"મધ્યમ", 3:"વધુ", 4:"ઘણું વધુ", 5:"ગંભીર", 0:"કોઈ નહીં"},
    "en": {1:"Low", 2:"Medium", 3:"High", 4:"Very High", 5:"Critical", 0:"None"},
}

# Crop names in all languages
CROP_NAMES_LANG = {
    "wheat":     {"hi":"गेहूं",    "mr":"गहू",      "kn":"ಗೋಧಿ",    "te":"గోధుమ",   "ta":"கோதுமை",  "pa":"ਕਣਕ",     "bn":"গম",      "gu":"ઘઉં",     "en":"Wheat"},
    "rice":      {"hi":"चावल",    "mr":"तांदूळ",   "kn":"ಅಕ್ಕಿ",   "te":"వరి",     "ta":"அரிசி",   "pa":"ਚਾਵਲ",    "bn":"ধান",     "gu":"ચોખા",    "en":"Rice"},
    "soybean":   {"hi":"सोयाबीन", "mr":"सोयाबीन",  "kn":"ಸೋಯಾಬೀನ್","te":"సోయాబీన్","ta":"சோயாபீன்","pa":"ਸੋਇਆਬੀਨ", "bn":"সয়াবিন",  "gu":"સોયાબીન", "en":"Soybean"},
    "cotton":    {"hi":"कपास",    "mr":"कापूस",    "kn":"ಹತ್ತಿ",   "te":"పత్తి",   "ta":"பருத்தி", "pa":"ਕਪਾਹ",    "bn":"তুলা",    "gu":"કપાસ",    "en":"Cotton"},
    "sugarcane": {"hi":"गन्ना",   "mr":"ऊस",       "kn":"ಕಬ್ಬು",   "te":"చెరకు",   "ta":"கரும்பு", "pa":"ਗੰਨਾ",    "bn":"আখ",      "gu":"શેરડી",   "en":"Sugarcane"},
    "onion":     {"hi":"प्याज",   "mr":"कांदा",    "kn":"ಈರುಳ್ಳಿ", "te":"ఉల్లిపాయ","ta":"வெங்காயம்","pa":"ਪਿਆਜ਼",  "bn":"পেঁয়াজ",  "gu":"ડુંગળી",  "en":"Onion"},
    "tomato":    {"hi":"टमाटर",   "mr":"टोमॅटो",   "kn":"ಟೊಮ್ಯಾಟೊ","te":"టమాటో",   "ta":"தக்காளி", "pa":"ਟਮਾਟਰ",   "bn":"টমেটো",   "gu":"ટામેટું",  "en":"Tomato"},
}
